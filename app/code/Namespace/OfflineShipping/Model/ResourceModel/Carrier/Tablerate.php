 ...
 */
namespace Namespace\OfflineShipping\Model\ResourceModel\Carrier;
...
class Tablerate extends \Magento\OfflineShipping\Model\ResourceModel\Carrier\Tablerate
{
    ...
    {
        // Added custo override to  match with 4 letters zip code
        $request->setDestPostcode(substr($request->getDestPostcode(), 0, 4));
